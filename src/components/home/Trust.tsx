      ...
      <Container className="relative z-10">
        ...
        <Reveal>
          <div className="rounded-stage border border-line bg-white/[0.02] p-8 sm:p-12 lg:p-16">
            ...
            <div className="relative">
              ...
              <h2 className="mt-4 max-w-[26ch] text-[28px] font-bold leading-[1.06] tracking-[-0.03em] text-fg sm:text-[36px]">
                Built on trust.{' '}
                <span className="text-fg-faint">Measured by results.</span>
              </h2>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {safeguards.map((s, i) => (
                  <Reveal key={s.title} delay={i * 60}>
                    <div className="py-3">
                      <h3 className="text-[20px] font-semibold text-fg-strong">{s.title}</h3>
                      <p className="mt-1.5 text-[14px] leading-[1.55] text-fg-muted">{s.description}</p>
                    </div>
                  </Reveal>
                ))}
              </div>
        ...
        <Reveal>
          <div className="mt-24 text-center sm:mt-32">
            <h2 className="mx-auto max-w-[22ch] text-[36px] font-bold leading-[1.02] tracking-[-0.04em] text-fg sm:text-[48px]">
              Ready to build{' '}
              <span className="text-spectral">what's next</span>?
            </h2>
            <p className="mx-auto mt-6 max-w-[52ch] text-[18px] leading-[1.55] text-fg-muted">
